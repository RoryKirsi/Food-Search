...
{
    public partial class FoodListController : UIViewController
    {
        public FoodListController (IntPtr handle) : base (handle)
        {
        }
		...
		public override void ViewDidLoad()
		{
			...
			FoodTable.Source = new TableSource(foodManager.Foods, this);
		...
		{
			if (segue.Identifier.Equals("FoodSegue"))
			{
				var viewController = segue.DestinationViewController as FoodDetailViewController;
				if (viewController != null)
				{
					var rowPath = FoodTable.IndexPathForSelectedRow;
					var food = (FoodManager.Create()).Foods[rowPath.Row];
